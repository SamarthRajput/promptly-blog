...
const page = async () => {
    ...
    //     text: `This is a test email sent using Resend. Here's a simple explanation of the theory of relativity:\n\n${response}`,
    //     html: `<h1>This is a test email sent using Resend</h1><p>Here's a simple explanation of the theory of relativity:</p><p>${response.replace(/\n/g, '<br>')}</p>`,
    // });
